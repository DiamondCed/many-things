...
data modify entity @e[type=item,distance=..2,limit=1,tag=change] Item.tag.AttributeModifiers append value {UUIDLeast:1,Operation:0,UUIDMost:54484,Slot:chest,AttributeName:generic.armor,Amount:6}
