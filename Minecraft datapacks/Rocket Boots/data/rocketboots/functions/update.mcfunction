...
tag @a[nbt={Inventory:[{tag:{isRocketBoots:1b}}]}] add hasRocketBoots
tag @a[nbt={EnderItems:[{tag:{isRocketBoots:1b}}]}] add hasRocketBoots
tag @a[nbt={Inventory:[{tag:{isSpectreBoots:1b}}]}] add hasSpectreBoots
tag @a[nbt={EnderItems:[{tag:{isSpectreBoots:1b}}]}] add hasSpectreBoots

execute as @e[type=item,nbt={Item:{tag:{isRocketBoots:1b}}}] unless entity @s[nbt={Item:{tag:{isSpectreBoots:1b}}}] at @s if block ~ ~-1 ~ #anvil if entity @e[type=item,nbt={Item:{tag:{isBoots:1b}}}] run function rocketboots:fuse
