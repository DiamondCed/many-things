execute if predicate flowerboots:plains run loot spawn ~ 0 ~ loot flowerboots:randomizer_plains
execute if predicate flowerboots:swamp run loot spawn ~ 0 ~ loot flowerboots:randomizer_swamp
execute if predicate flowerboots:flower_forest run loot spawn ~ 0 ~ loot flowerboots:randomizer_flower_forest
execute unless predicate flowerboots:plains unless predicate flowerboots:swamp unless predicate flowerboots:flower_forest run loot spawn ~ 0 ~ loot flowerboots:randomizer_generic
