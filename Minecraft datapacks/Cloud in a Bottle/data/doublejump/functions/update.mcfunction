...
tag @a[nbt={Inventory:[{tag:{isCloud:1b}}]}] add hasCloud
tag @a[nbt={Inventory:[{tag:{isBlizzard:1b}}]}] add hasBlizzard
tag @a[nbt={Inventory:[{tag:{isSandstorm:1b}}]}] add hasSandstorm
tag @a[nbt={EnderItems:[{tag:{isCloud:1b}}]}] add hasCloud
tag @a[nbt={EnderItems:[{tag:{isBlizzard:1b}}]}] add hasBlizzard
tag @a[nbt={EnderItems:[{tag:{isSandstorm:1b}}]}] add hasSandstorm
