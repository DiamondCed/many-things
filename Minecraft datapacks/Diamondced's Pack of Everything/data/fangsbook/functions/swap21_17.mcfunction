...
data modify entity @e[type=armor_stand,limit=1,sort=nearest,tag=temp_BoF] ArmorItems[2].tag.mode set value 1
data modify entity @e[type=armor_stand,limit=1,sort=nearest,tag=temp_BoF] ArmorItems[2].tag.CustomModelData set value 98
data modify entity @e[type=armor_stand,limit=1,sort=nearest,tag=temp_BoF] ArmorItems[2].tag.display.Lore[0] set value '{"text":"Mode: Line","color":"gray","italic":"false"}'
