...
data modify entity @e[type=item,limit=1,sort=nearest,tag=newitem] Item.tag.mode set value 1
data modify entity @e[type=item,limit=1,sort=nearest,tag=newitem] Item.tag.CustomModelData set value 98
data modify entity @e[type=item,limit=1,sort=nearest,tag=newitem] Item.tag.display.Lore[0] set value '{"text":"Mode: Line","color":"gray","italic":"false"}'
