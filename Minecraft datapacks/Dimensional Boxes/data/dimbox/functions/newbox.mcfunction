#say box2+
execute as @e[tag=boxmarker] at @s in the_nether run forceload add ~ ~2
execute as @e[tag=boxmarker] at @s in the_nether run tp @s ~ ~ ~32
execute as @e[tag=boxmarker] at @s in the_nether run summon armor_stand ~ 192 ~ {Marker:1b,NoGravity:1b,Invisible:1b,Tags:["boxtp"]}
