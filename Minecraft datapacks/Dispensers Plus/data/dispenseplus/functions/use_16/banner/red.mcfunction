...
execute if entity @s[tag=found,tag=west] run setblock ~ ~ ~ red_wall_banner[facing=west]
execute if entity @s[tag=found,tag=east] run setblock ~ ~ ~ red_wall_banner[facing=east]
execute if entity @s[tag=found,tag=north] run setblock ~ ~ ~ red_wall_banner[facing=north]
execute if entity @s[tag=found,tag=south] run setblock ~ ~ ~ red_wall_banner[facing=south]
execute if entity @s[tag=found,tag=up] run setblock ~ ~ ~ red_banner[rotation=12]
