...
execute if entity @s[tag=found,tag=west] run setblock ~ ~ ~ cyan_wall_banner[facing=west]
execute if entity @s[tag=found,tag=east] run setblock ~ ~ ~ cyan_wall_banner[facing=east]
execute if entity @s[tag=found,tag=north] run setblock ~ ~ ~ cyan_wall_banner[facing=north]
execute if entity @s[tag=found,tag=south] run setblock ~ ~ ~ cyan_wall_banner[facing=south]
execute if entity @s[tag=found,tag=up] run setblock ~ ~ ~ cyan_banner[rotation=12]
