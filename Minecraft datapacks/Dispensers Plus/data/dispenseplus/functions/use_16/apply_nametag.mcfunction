...
data modify entity @e[dx=0,dy=0,dz=0,limit=1] CustomName set from entity @s Item.tag.display.Name
data modify entity @e[dx=0,dy=0,dz=0,limit=1] PersistenceRequired set value 1b
