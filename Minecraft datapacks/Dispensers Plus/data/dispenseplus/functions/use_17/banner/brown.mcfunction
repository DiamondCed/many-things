...
execute if entity @s[tag=found,tag=west] run setblock ~ ~ ~ brown_wall_banner[facing=west]
execute if entity @s[tag=found,tag=east] run setblock ~ ~ ~ brown_wall_banner[facing=east]
execute if entity @s[tag=found,tag=north] run setblock ~ ~ ~ brown_wall_banner[facing=north]
execute if entity @s[tag=found,tag=south] run setblock ~ ~ ~ brown_wall_banner[facing=south]
execute if entity @s[tag=found,tag=up] run setblock ~ ~ ~ brown_banner[rotation=12]
