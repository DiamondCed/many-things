...
execute if entity @s[tag=found,tag=west] run setblock ~ ~ ~ blue_wall_banner[facing=west]
execute if entity @s[tag=found,tag=east] run setblock ~ ~ ~ blue_wall_banner[facing=east]
execute if entity @s[tag=found,tag=north] run setblock ~ ~ ~ blue_wall_banner[facing=north]
execute if entity @s[tag=found,tag=south] run setblock ~ ~ ~ blue_wall_banner[facing=south]
execute if entity @s[tag=found,tag=up] run setblock ~ ~ ~ blue_banner[rotation=12]
