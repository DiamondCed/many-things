...
execute if entity @s[tag=found,tag=west] run setblock ~ ~ ~ lime_wall_banner[facing=west]
execute if entity @s[tag=found,tag=east] run setblock ~ ~ ~ lime_wall_banner[facing=east]
execute if entity @s[tag=found,tag=north] run setblock ~ ~ ~ lime_wall_banner[facing=north]
execute if entity @s[tag=found,tag=south] run setblock ~ ~ ~ lime_wall_banner[facing=south]
execute if entity @s[tag=found,tag=up] run setblock ~ ~ ~ lime_banner[rotation=12]
